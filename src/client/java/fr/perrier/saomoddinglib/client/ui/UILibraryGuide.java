package fr.perrier.saomoddinglib.client.ui;

/**
 * SAO Modding UI Library - A simple and intuitive framework for creating Minecraft mod menus.
 *
 * ## Features
 ...
 *
 * ```java
 * import static fr.perrier.saomoddinglib.client.ui.api.Components.*;
 ...
 *
 * ```
 * fr.perrier.saomoddinglib.client.ui
